                ...
                <div className='md:w-[85%] md:float-right mt-15 md:mt-2'>
                    ...
                    <div className='bg-slate-700 rounded-2xl w-[90%] grid grid-cols-2 m-5 p-2 mb-5 '>
                        <div className='text-slate-100 w-[80%]   '>
                            <div className='text-xl p-2 '><h1 className='p-2'>Name: </h1> <input value={name} className='bg-slate-50  text-slate-800 p-2 rounded w-[80%]' ></input>
                                <button className='text-sm p-2 bg-green-500 m-1 rounded-2xl cursor-pointer'>Update</button></div>
                        </div>
                        <div className='text-slate-100 w-[80%]'>
                            <div className='text-xl p-2'> <h1 className='p-2'>Email:</h1><h1 className='bg-slate-50  text-slate-800 p-2 rounded' >{email}</h1></div>
                        </div>
                        <div className='text-slate-100 w-[80%]'>
                            <div className='text-xl p-2'><h1 className='p-2'>Gender: </h1> <input value={gender} className='bg-slate-50  text-slate-800 p-2 rounded w-[80%]' ></input>
                                <button className='text-sm p-2 bg-green-500 m-1 rounded-2xl cursor-pointer'>Update</button></div>
                        </div>
                        <div className='text-slate-100  w-[80%]'>
                            <div className='text-xl p-2'> <h1 className='p-2'>Weight: </h1> <input value={weight} className='bg-slate-50  text-slate-800 p-2 rounded w-[80%]' ></input>
                                <button className='text-sm p-2 bg-green-500 m-1 rounded-2xl cursor-pointer'>Update</button></div>
                        </div>
                        <div className='text-slate-100  w-[80%]'>
                            <div className='text-xl p-2'><h1 className='p-2'>Height:</h1><input value={height} className='bg-slate-50  text-slate-800 p-2 rounded w-[80%]' placeholder='N.a' ></input>
                                <button className='text-sm p-2 bg-green-500 m-1 rounded-2xl cursor-pointer'>Update</button></div>
                        </div>
                        <div className='text-slate-100  w-[80%]'>
